...
{
	private final static String METAIO_SDK_SIGNATURE = "CCJtQJgQ7cad8d4DLK0WyLCyu4hXwqQnDRk30wQZylY=";
	/**
	...
	public void onCreate(Bundle savedInstanceState)
	{
		...
		try
		{
			...
			metaioSDK = MetaioSDK.CreateMetaioSDKAndroid(this,this.METAIO_SDK_SIGNATURE);
